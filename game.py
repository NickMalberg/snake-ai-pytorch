...
pygame.init()  # pylint: disable=no-member,import-error
...
class SnakeGameAI:
    ...
    def play_step(self, action):
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:  # pylint: disable=no-member,import-error
                pygame.quit()  # pylint: disable=no-member,import-error
                quit()
